...
SECRET_KEY = 'django-insecure-qefxyv)@)jyr=axm_=d$si45y-(mn$sk_bp2u&d0)+90i#!r7)'
...
# Que va a hacer Django cuando pase un error 404
HANDLER404 = 'app.views.show_error_404'

# Que va a hacer Django cuando pase un error 500
HANDLER500 = 'app.views.show_error_500'

DATABASES = {
    'default': {
        'ENGINE': 'django.db.backends.mysql',  # Motor de base de datos
        'NAME': 'errorPages',           # Nombre de la base de datos
